...
SMPLX_NPZ_ANIMATION_FOLDER = Path("/data/gendered_ground_truth")
...
OUTPUT_IMAGE_ROOT = Path("/data/image")
################################################################################
...
if __name__ == "__main__":
    ...
    # Get sequences
    print(c, grouptype, subject_animations, SMPLX_NPZ_ANIMATION_FOLDER,"----")
